"""
An axis-aligned box padded around `points`, generic over `N` -- the
dimension-generic analogue of the 2D prototype's `padded_bbox`.
"""
...
"""
Brute-force oracle matching the 2D prototype's `brute_force_label`: the
set of input point indices (`1` or `2`) achieving the minimum squared
distance to `x`, within floating-point tie tolerance.
"""
